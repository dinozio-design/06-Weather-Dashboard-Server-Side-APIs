function init() {
    ...
    function renderAheadCards(obj) {
        ...
        <div class="card-image"><figure class="image is-48x48"><img src="https://openweathermap.org/img/wn/${obj.weather[0].icon}@2x.png" alt="Placeholder image"></figure></div><div class="content">
